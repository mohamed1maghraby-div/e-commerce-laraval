...
class FeatruedProduct extends Component
{
    use LivewireAlert;
    ...
    {
        return view('livewire.frontend.featrued-product', ['featuredProducts' => 
        Product::with('firstMedia')->inRandomOrder()
        ->Featured()->active()->HasQuantity()->ActiveCategory()->take(8)->get()
    ]);
    }
}
