                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="password" value="{{ old('password', $supervisor->password) }}" name="password" class="form-control" >
                    ...
                    <div class="form-group">
                        ...
                        <select name="permissions[]" class="form-control select-multiple-tags" multiple="multiple">
                            @forelse ($permissions as $permission)
                                <option value="{{ $permission->id }}" {{ in_array($permission->id, old('permissions', $supervisorPermissions)) ? 'selected' : null }}>
