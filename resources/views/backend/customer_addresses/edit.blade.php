                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="user_id" id="user_id" value="{{ $customer_address->user->id }}" readonly>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="address" id="address" value="{{ old('address', $customer_address->address) }}">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="address2" id="address2" value="{{ old('address2', $customer_address->address2) }}">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="zip_code" id="zip_code" value="{{ old('zip_code', $customer_address->zip_code) }}">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="po_box" id="po_box" value="{{ old('po_box', $customer_address->po_box) }}">
