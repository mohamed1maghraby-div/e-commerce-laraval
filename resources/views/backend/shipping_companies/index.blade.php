        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <a href="javascript:void(0);" onclick="if(confirm('Are you sure to delete this record?')){document.getElementById('delete-shipping_company-{{ $shipping_company->id }}').submit(); }else{return false;}" class="btn btn-danger">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center">No shipping companies found</td>
                        </tr>
                    @endforelse
                </tbody>
                <tfoot>
