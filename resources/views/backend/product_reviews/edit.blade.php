            ...
            <form action="{{ route('admin.product_reviews.update', $productReview->id) }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <select name="rating" class="form-control">
                            <option value="">---</option>
                                <option value="1" {{ old('rating', $productReview->rating) == '2' ? 'selected' : null }}>1</option>
                                <option value="2" {{ old('rating', $productReview->rating) == '2' ? 'selected' : null }}>2</option>
                                <option value="3" {{ old('rating', $productReview->rating) == '2' ? 'selected' : null }}>3</option>
                                <option value="4" {{ old('rating', $productReview->rating) == '2' ? 'selected' : null }}>4</option>
                                <option value="5" {{ old('rating', $productReview->rating) == '2' ? 'selected' : null }}>5</option>
                        </select>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="hidden" name="title" value="{{ $productReview->title }}" class="form-control">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <textarea name="message" id="" class="form-control">{{ $productReview->message }}</textarea>
