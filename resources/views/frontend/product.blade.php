                ...
                <div class="swiper-wrapper">
                  @foreach ($product->media as $media)
                    <div class="swiper-slide h-auto">
                      <a class="glightbox product-view" href="{{ asset('assets/products/' . $media->file_name) }}" data-gallery="gallery2" data-glightbox="Product item {{ $loop->index }}" title="{{ $product->name }}">
        ...
        <div class="col-lg-6">
          ...
          <ul class="list-unstyled small d-inline-block">
            <li class="px-3 py-2 mb-1 bg-white text-muted">
              ...
              <a class="reset-anchor ms-2" href="#!">{{ $product->category->name }}</a>
            </li>
            <li class="px-3 py-2 mb-1 bg-white text-muted">
                        ...
                        @if ($review->rating != '')
                          @for ($i=0; $i<5; $i++)
                              <li class="list-inline-item m-0">
                                <i class="{{ round($review->rating) <= $i ? 'far' : 'fas' }} fa-star text-warning"></i>
                              </li>
                          @endfor
                        @else
                            <li class="list-inline-item m-0"><i class="far fa-star fa-sm text-warning"></i></li>
