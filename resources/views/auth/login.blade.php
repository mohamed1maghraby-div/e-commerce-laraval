            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('username') is-invalid @enderror form-control-lg" name="username"
                            type="text" value="{{ old('username') }}" placeholder="Enter your Username" required >
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control @error('username') is-invalid @enderror form-control-lg"
                ...
                <div class="col-lg-6 form-group">
                    <div class="custom-control custom-checkbox">
                        <input class="custom-control-input" type="checkbox" name="remember" id="remember" {{ old('remember')
                            ? 'checked' : '' }}>
