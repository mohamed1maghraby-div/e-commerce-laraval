...
class EntrustSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //PRODUCT REVIEWS
        //$manageProductReviews =  Permission::create([ 'name' => 'manage_product_reviews', 'display_name' => 'Reviews', 'route' => 'product_coupons', 'module' => 'product_coupons', 'as' => 'product_coupons.index', 'icon' => 'fas fa-comment', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '20']);
        //$manageProductReviews->parent_show = $manageProductReviews->id;
        //$manageProductReviews->save();
        //$showProductCoupons =  Permission::create([ 'name' => 'show_product_product_reviews', 'display_name' => 'Reviews', 'route' => 'product_product_reviews', 'module' => 'product_product_reviews', 'as' => 'product_product_reviews.index', 'icon' => 'fas fa-comment', 'parent' => $manageProductReviews->id, 'parent_original' => $manageProductReviews->id, 'parent_show' => $manageProductReviews->id, 'sidebar_link' => '1', 'appear' => '1']);
        //$createProductCoupons =  Permission::create([ 'name' => 'create_product_product_reviews', 'display_name' => 'Create Review', 'route' => 'product_product_reviews', 'module' => 'product_product_reviews', 'as' => 'product_product_reviews.create', 'icon' => null, 'parent' => $manageProductReviews->id, 'parent_original' => $manageProductReviews->id, 'parent_show' => $manageProductReviews->id, 'sidebar_link' => '1', 'appear' => '0']);
        //$displayProductCoupons =  Permission::create([ 'name' => 'display_product_product_reviews', 'display_name' => 'Show Review', 'route' => 'product_product_reviews', 'module' => 'product_product_reviews', 'as' => 'product_product_reviews.show', 'icon' => null, 'parent' => $manageProductReviews->id, 'parent_original' => $manageProductReviews->id, 'parent_show' => $manageProductReviews->id, 'sidebar_link' => '1', 'appear' => '0']);
        //$updateProductCoupons =  Permission::create([ 'name' => 'update_product_product_reviews', 'display_name' => 'Update Review', 'route' => 'product_product_reviews', 'module' => 'product_product_reviews', 'as' => 'product_product_reviews.edit', 'icon' => null, 'parent' => $manageProductReviews->id, 'parent_original' => $manageProductReviews->id, 'parent_show' => $manageProductReviews->id, 'sidebar_link' => '1', 'appear' => '0']);
        //$deleteProductCoupons =  Permission::create([ 'name' => 'delete_product_product_reviews', 'display_name' => 'Delete Review', 'route' => 'product_product_reviews', 'module' => 'product_product_reviews', 'as' => 'product_product_reviews.destroy', 'icon' => null, 'parent' => $manageProductReviews->id, 'parent_original' => $manageProductReviews->id, 'parent_show' => $manageProductReviews->id, 'sidebar_link' => '1', 'appear' => '0']);
