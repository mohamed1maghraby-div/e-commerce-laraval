...
const AdminAddProduct = () => {
    ...
    const [onChangeProdName, onChangeDescName, onChangePriceBefore, onChangePriceAfter, onChangeQty, onChangeColor,showColor,categories,brands,priceAfter,images,setImages,onRemove,options,
        handleChangeComplete,removeColor,onSelectCategory,handelSubmit,onSelectBrand,colors,priceBefore,
        qty,prodDescription,prodName,onSelect] = AdminAddProductHook();
